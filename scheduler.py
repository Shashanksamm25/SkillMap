"""
scraper/scraper.py
Fetches real job data from Arbeitnow API (free, no API key needed).
Stores into PostgreSQL via SQLAlchemy.
"""
...
def save_jobs(jobs: list, session) -> int:
    ...
    for job in jobs:
        ...
        # Extract and save skills from title + tags + description
